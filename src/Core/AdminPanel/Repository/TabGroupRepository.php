    ...
    private function siteDefaults(): array
    {
        return [
            'groups' => [
                ...
                'notifications' => ['label' => __('Email Notifications', 'wpcd'), 'order' => 85, 'icon' => 'fas fa-envelope'],
                'notes'         => ['label' => __('Descriptions, Notes & Labels', 'wpcd'), 'order' => 88, 'icon' => 'fas fa-note-sticky'],
            ],
            'tabs'   => [
                ...
                'wpcd_email_addresses'     => ['group' => 'notifications', 'icon' => 'fas fa-at'],
                'wpcd_compose_email'       => ['group' => 'notifications', 'icon' => 'fas fa-pen-to-square'],
                'wpcd_sent_email'          => ['group' => 'notifications', 'icon' => 'fas fa-paper-plane'],
                'wpcd_descriptions'        => ['group' => 'notes', 'icon' => 'fas fa-align-left'],
                'wpcd_notes'               => ['group' => 'notes', 'icon' => 'fas fa-note-sticky'],
                'wpcd_labels'              => ['group' => 'notes', 'icon' => 'fas fa-tags'],
                'wpcd_links'               => ['group' => 'notes', 'icon' => 'fas fa-link'],
                'wpcd_admin_only_notes'    => ['group' => 'notes', 'icon' => 'fas fa-user-shield'],
            ],
        ];
    }
    ...
    private function serverDefaults(): array
    {
        return [
            'groups' => [
                ...
                'notifications' => ['label' => __('Email Notifications', 'wpcd'), 'order' => 70, 'icon' => 'fas fa-envelope'],
                'notes'         => ['label' => __('Descriptions, Notes & Labels', 'wpcd'), 'order' => 80, 'icon' => 'fas fa-note-sticky'],
            ],
            'tabs'   => [
                'general'              => ['group' => 'general', 'icon' => 'fas fa-circle-info'],
